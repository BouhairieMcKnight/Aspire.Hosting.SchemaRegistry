...
public static class SchemaRegistryResourceExtensions
{
    ...
    /// <summary>
    /// Adds a confluent schema registry <see cref="ContainerResource"/> to application. 
    /// </summary>
    /// <param name="builder">The <see cref="IDistributedApplicationBuilder"/>.</param>
    /// <param name="name">The name of the resource that will be used in the <see cref="ReferenceEnvironmentInjectionAnnotation"/>.</param>
    /// <param name="port">The host port of the confluent schema registry.</param>
    /// <returns>
    /// returns a reference to <see cref="IResourceBuilder{SchemaRegistryResource}"/>.
    /// </returns>
